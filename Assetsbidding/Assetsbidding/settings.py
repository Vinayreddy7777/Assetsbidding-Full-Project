"""
Django settings for Assetsbidding project.
...
SECRET_KEY = 'django-insecure-zusw#k@=%6z8n*ollyx$(p-%0b4^8$gcs^b-mrfpug9e9)h8+e'
...
ROOT_URLCONF = 'Assetsbidding.urls'
...
WSGI_APPLICATION = 'Assetsbidding.wsgi.application'
